...
for k in [2,3,4,5]:
    for n in [4,8,16,32]:
        for training, validation in tr_val_set:
            ...
            learningcurvefile = f'{curfolder}\\learning_curves\\{training}_{validation}_n_{n}_k_{k}_v2_avg.csv'
            weightsfile = f'{curfolder}\\trained_weights\\{training}weights_n_{n}_k_{k}_v2_avg.pt'
